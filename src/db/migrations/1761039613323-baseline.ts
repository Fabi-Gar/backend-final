...
export class Baseline1761039613323 implements MigrationInterface {
    name = 'Baseline1761039613323'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "notificaciones" ("notificacion_uuid" uuid NOT NULL DEFAULT uuid_generate_v4(), "usuario_uuid" uuid NOT NULL, "titulo" VARCHAR(255) NOT NULL, "mensaje" TEXT NOT NULL, "tipo" VARCHAR(50), "payload" jsonb, "leida_en" TIMESTAMP WITH TIME ZONE, "creado_en" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_f4228a4d04139e6fb3f6685bae4" PRIMARY KEY ("notificacion_uuid"))`);
        ...
        await queryRunner.query(`CREATE TABLE "tipos_incendio" ("tipo_incendio_id" text NOT NULL DEFAULT gen_random_uuid(), "nombre" text NOT NULL, "creado_en" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "actualizado_en" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "eliminado_en" TIMESTAMP WITH TIME ZONE, CONSTRAINT "UQ_190d287b378e730984ea6b57cea" UNIQUE ("nombre"), CONSTRAINT "PK_73b407a180bef892cd3703ec3bc" PRIMARY KEY ("tipo_incendio_id"))`);
        await queryRunner.query(`CREATE TABLE "cierre_operaciones" ("incendio_uuid" uuid NOT NULL, "tipo_incendio_principal_id" text, "creado_en" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "actualizado_en" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "eliminado_en" TIMESTAMP WITH TIME ZONE, CONSTRAINT "PK_9c7a2d475639f54d65d4d6202ef" PRIMARY KEY ("incendio_uuid"))`);
        ...
        await queryRunner.query(`CREATE TABLE "tipo_propiedad" ("tipo_propiedad_id" text NOT NULL DEFAULT gen_random_uuid(), "nombre" text NOT NULL, "creado_en" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "actualizado_en" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "eliminado_en" TIMESTAMP WITH TIME ZONE, CONSTRAINT "UQ_7270df4f0b824de9f69e76ac0f0" UNIQUE ("nombre"), CONSTRAINT "PK_273e77c7435341872e0b3fc9e31" PRIMARY KEY ("tipo_propiedad_id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "medios_terrestres_catalogo" ("medio_terrestre_id" text NOT NULL DEFAULT uuid_generate_v4(), "nombre" text NOT NULL, "creado_en" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "actualizado_en" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "eliminado_en" TIMESTAMP WITH TIME ZONE, CONSTRAINT "UQ_470126450b2722a69502f57154b" UNIQUE ("nombre"), CONSTRAINT "PK_6417f53fdb74d3a3ebf9af40f8c" PRIMARY KEY ("medio_terrestre_id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "medios_aereos_catalogo" ("medio_aereo_id" text NOT NULL DEFAULT uuid_generate_v4(), "nombre" text NOT NULL, "creado_en" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "actualizado_en" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "eliminado_en" TIMESTAMP WITH TIME ZONE, CONSTRAINT "UQ_0ccc03f377efa9c89607fc1b12d" UNIQUE ("nombre"), CONSTRAINT "PK_d59ae0c9d7cb54691778bfd3b9c" PRIMARY KEY ("medio_aereo_id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "iniciado_junto_a_catalogo" ("iniciado_id" text NOT NULL DEFAULT uuid_generate_v4(), "nombre" text NOT NULL, "creado_en" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "actualizado_en" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "eliminado_en" TIMESTAMP WITH TIME ZONE, CONSTRAINT "UQ_351d23a53eca1f3a83d93c83b3f" UNIQUE ("nombre"), CONSTRAINT "PK_08e2a3acbfe9d0ab3fcf7728740" PRIMARY KEY ("iniciado_id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "medios_acuaticos_catalogo" ("medio_acuatico_id" text NOT NULL DEFAULT uuid_generate_v4(), "nombre" text NOT NULL, "creado_en" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "actualizado_en" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "eliminado_en" TIMESTAMP WITH TIME ZONE, CONSTRAINT "UQ_9e136502d82110ede15a140e511" UNIQUE ("nombre"), CONSTRAINT "PK_ff888581cd1bbd5c2016e64ea40" PRIMARY KEY ("medio_acuatico_id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "causas_catalogo" ("causa_id" text NOT NULL DEFAULT uuid_generate_v4(), "nombre" text NOT NULL, "creado_en" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "actualizado_en" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "eliminado_en" TIMESTAMP WITH TIME ZONE, CONSTRAINT "UQ_7d5df5fff4fb35cb8e66a210951" UNIQUE ("nombre"), CONSTRAINT "PK_ff90796bd4161834658b65ba7e9" PRIMARY KEY ("causa_id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "abastos_catalogo" ("abasto_id" text NOT NULL DEFAULT uuid_generate_v4(), "nombre" text NOT NULL, "creado_en" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "actualizado_en" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "eliminado_en" TIMESTAMP WITH TIME ZONE, CONSTRAINT "UQ_a06a1939c6cf556b456764f84b1" UNIQUE ("nombre"), CONSTRAINT "PK_2690fa67cdf01ee676fe4a738de" PRIMARY KEY ("abasto_id"))`);

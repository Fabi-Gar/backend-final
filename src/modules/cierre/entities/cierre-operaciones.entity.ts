import { Entity, PrimaryColumn, OneToOne, JoinColumn, CreateDateColumn, UpdateDateColumn, DeleteDateColumn, ManyToOne, Column } from 'typeorm'
...
export class CierreOperaciones {
  ...
  @JoinColumn({ name: 'incendio_uuid', referencedColumnName: 'incendio_uuid', foreignKeyConstraintName: 'fk_cierre_operaciones_incendio_uuid' })
  incendio!: Incendio

  @ManyToOne(() => TipoIncendio, { nullable: true })
  @JoinColumn({ name: 'tipo_incendio_principal_id', referencedColumnName: 'tipo_incendio_id', foreignKeyConstraintName: 'fk_cierre_operaciones_tipo_incendio' })
